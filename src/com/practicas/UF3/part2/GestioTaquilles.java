...
public class GestioTaquilles {
	...
	public static void main(String[] args) {
		File paquetsSenseLloc = new File("PaquetsSenseLloc.csv");
		if (!paquetsSenseLloc.exists()) {
			try {
				paquetsSenseLloc.createNewFile();
				PrintStream escriptor = new PrintStream(paquetsSenseLloc);
				escriptor.print("Taquilla;Destinatari;pes;alcada;amplada;profunditat\n"); 
				escriptor.close();
